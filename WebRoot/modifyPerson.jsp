...
<head>
	...
	<%  String nicheng =(String)session.getAttribute("UserNicheng");
		stuInfo stu = stuSer.queryStubyNicheng(nicheng);
		if(stu==null){
			RequestDispatcher rd = request.getRequestDispatcher("ERROR.jsp");
			request.setAttribute("error2", "ERROR402");
...
<body background="images/newhead.jpg" style="background-size: cover;">
	<form action="modifyOneStu_result.jsp" method="post" >
		<table bgColor="#c0c0c0" align="center">
			...
			<tr>
				<td align="center" bgcolor=#6A6AFF colspan=3><font color=white>BIT学生信息修改</font></td>
